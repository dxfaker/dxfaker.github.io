...
<feed xmlns="http://www.w3.org/2005/Atom">
  <title>dxfaker's blog</title>
  <subtitle>一个默默无闻的小站</subtitle>
  <link href="https://dxfaker.top/" rel="alternate" type="text/html"/>
  <link href="https://dxfaker.top/atom.xml" rel="self" type="application/atom+xml"/>
  <id>https://dxfaker.top/</id>
  <updated>2026-08-14T03:56:38.119Z</updated>
  <language>en</language>
  <entry>
    <title>2026moectf第一周wp</title>
    <link href="https://dxfaker.top/posts/2026moectfre/" rel="alternate" type="text/html"/>
    <id>https://dxfaker.top/posts/2026moectfre/</id>
    <published>2026-08-14T00:00:00.000Z</published>
    <updated>2026-08-14T00:00:00.000Z</updated>
    <summary>新生杯第一周倒是非常简单,这个时候有人就要问了，你不是老登吗，写个蛋的新生杯，那我问你，我后面是不是要打26Aurora ctf</summary>
    <content type="html"><![CDATA[<h1>写在前面</h1>
<p>最近不是要买商品房当宿舍吗，这个是之前给liv研究生租房时的图</p>
<h1>逆向入门指北</h1>
<p>这个题主要是让你看pdf的，甚至没必要查壳(当然每个题都要查)</p>
<p><img src="https://dxfaker.top/images/post/5956b2b6f3c0c5412731cb67defe2418.png" alt="5956b2b6f3c0c5412731cb67defe2418" /></p>
<p>拖进ida就能看见答案也没啥好说的</p>
<h1>bbxor</h1>
<p>查壳没啥问题，进ida看，</p>
<p><img src="https://dxfaker.top/images/post/f1baacbb6a89789b45421cf6dd0b8f0f.png" alt="f1baacbb6a89789b45421cf6dd0b8f0f" /></p>
<p>然后发现只做了一步很简单的XOR，由对称性，XOR回去就行了。</p>
<h1>让我们说中文</h1>
<p>查壳没什么问题，拖进IDA</p>
<p><img src="https://dxfaker.top/images/post/d802e096-0241-4155-874b-44c449ef6d1d.png" alt="d802e096-0241-4155-874b-44c449ef6d1d" /></p>
<p>根据</p>
<pre><code>env = (const char *)sub_401480(flag, len);
</code></pre>
<p>点进sub_401480</p>
<p><img src="https://dxfaker.top/images/post/6a4d62f2-a78c-4476-9d93-5ff648858b96.png" alt="6a4d62f2-a78c-4476-9d93-5ff648858b96" /></p>
<p>先进sub_4012F0</p>
<p><img src="https://dxfaker.top/images/post/f90d952b-d74d-4f82-91c3-1d0e5611080f.png" alt="f90d952b-d74d-4f82-91c3-1d0e5611080f" /></p>
<p>再加上</p>
<pre><code>  v4 = malloc(4 * ((a2 + 2) / 3) + 1);
</code></pre>
<blockquote>
<ul>
...
<p>基本可以确定是base64相关</p>
<p>再看回来</p>
<pre><code>result = (_BYTE *)sub_4012F0();               // 在这里进行base64编码，对flag以及len操作
  if ( result )
  {
    v1 = *result;
    if ( *result )
...
<p>如果对于result的每一个值，不等于61(=)的话，将其用aSix5tarspjyoun[v3]替换(++v3 == 64是先++再比较64，即64 个字符的自定义表找不到就跳转LABEL_9)</p>
<p>核心逻辑就是：先base64,然后不等于61的用自定义字典同序号字符替换。</p>
<p>逆向过来就是把两个字典的位置换一下就好了，然后赛博厨子"from base64"</p>
<h1>手写汇编</h1>
<pre><code>; x86-64, Intel syntax
...
<p>逻辑在注释里标的很清楚了，详细知识可以看huoya爷或者国资社畜的资料。</p>
<p>byte_404000不用动，byte_404020要XOR0x42再加上即可。</p>
<h1>请你喝茶</h1>
<p>week1怎么没一个要脱壳的</p>
<p><img src="https://dxfaker.top/images/post/4d75f0ae-9776-4cee-bb28-015fa4034d8a.png" alt="4d75f0ae-9776-4cee-bb28-015fa4034d8a" /></p>
<p>开IDA，发现xteapart是v15+16开始，长度v16为32，那么一半tea一半xtea.</p>
<p><img src="https://dxfaker.top/images/post/7627702f-3b4e-415e-91c5-1a81cfe5e672.png" alt="7627702f-3b4e-415e-91c5-1a81cfe5e672" /></p>
<p>跟着代码走，追到这里，发现全部参数都齐了，那就可以开始写脚本了。</p>
<p>bing上一搜就能看到TEA/XTEA的加密以及解密原理了</p>
<p>简明扼要，由于加密的每一轮操作在已知密钥下都是可逆的，只需要将其逆过来便可以完成解密</p>
<pre><code>  v6 = *a1;
  v5 = a1[1];
  delta1 = 0;
  for ( i = 0; i &lt;= 0x1F; ++i )
...
<p>解密便是把循环的这三条顺序反过来，+=改成-=, v5v6位置一换，就可以了。XTEA同理</p>
<p>k[(sum &gt;&gt; 11) &amp; 3] 只由 sum 这个数决定。此处解密属于撤销行为，所以不用动</p>
<p>再把tea_cipher以及xtea_cipher带入运算即可。</p>
<blockquote>
...
<h1>总结</h1>
<p>毕竟是week1，挺简单的，不过后面我有点想跑路pwn了，所以这几天进度很缓慢（主要是汇编又在赤石，又看不懂了....)</p>
<p>还有，艾斯比电分不给我补考，估计要度过一个很傻逼的大二大三了</p>
]]></content>
    <author>
      <name></name>
    </author>
    <category term="wp"></category>
  </entry>
  <entry>
    <title>SEH问题处理</title>
    <link href="https://dxfaker.top/posts/seh/" rel="alternate" type="text/html"/>
    <id>https://dxfaker.top/posts/seh/</id>
    <published>2026-07-25T00:00:00.000Z</published>
    <updated>2026-07-25T00:00:00.000Z</updated>
    <summary>属于WP吧，讲讲处理思路</summary>
    <content type="html"><![CDATA[<h1>前言</h1>
<p>感谢leyi提供的南区美照</p>
<p>经过了激烈的期末月斗争，我的电分还是挂了(目前还不清楚有没有补考)。</p>
<p>然后从暑假开始复健逆向。</p>
<p>第一天我就写了两个题目，一个是hex的，开010拉到底部就结束战斗了，另外一个就是今天讲的SEH。</p>
<h1>你需要知道的</h1>
<ol>
<li>SEH是什么</li>
</ol>
...
<p>异常发生后，大概顺序是：内核-&gt;调试器-&gt;VEH-&gt;SEH</p>
<blockquote>
...
<h1>题目内容</h1>
<p>西电的<a href="https://ctf.xidian.edu.cn/training/2?challenge=522">强壮逆向人 - 西电 CTF 终端</a>这个题</p>
<p>查壳发现没有什么问题，然后就可以拖进IDA里面看代码了</p>
<p>&lt;img src="/images/post/屏幕截图 2026-07-25 143104.png" alt="屏幕截图 2026-07-25 143104" /&gt;</p>
<p>乍一看，并没有什么难的，然后就去打开byte_140005010、dword_140005000、unk_140005110、sub_140001020看一下内容。然后我就直接去搓解密脚本了。</p>
<p>&lt;img src="/images/post/屏幕截图 2026-07-25 143827.png" alt="屏幕截图 2026-07-25 143827" /&gt;</p>
<p>剩下部分数据处理好就可以输出解密脚本了。</p>
<p>但能解出来吗，很显然不行</p>
<p>那问题出在哪呢</p>
<p><code>puts("Can you read my assembly in exception?");</code></p>
<p>以及题目提示</p>
<blockquote>
...
<p>然后就需要我们去看汇编&lt;img src="/images/post/屏幕截图 2026-07-25 144520.png" alt="屏幕截图 2026-07-25 144520" /&gt;</p>
<p>可以直接看到有SEH的字样，拉到<code>v5 = (127 * v5 + 102) % 255;</code>这句话的汇编代码时，发现里面大有文章。</p>
<p>&lt;img src="/images/post/屏幕截图 2026-07-25 144743.png" alt="屏幕截图 2026-07-25 144743" /&gt;</p>
<p>这里快速复习一下汇编代码</p>
<table>
<thead>
<tr>
...
<tr>
<td><code>cdq</code></td>
<td>将 <code>eax</code> 符号扩展为 <code>edx:eax</code>（用于除法）</td>
</tr>
<tr>
<td><code>idiv</code></td>
<td>有符号整数除法（商在 <code>eax</code>，余数在 <code>edx</code>）</td>
</tr>
<tr>
<td><code>sar</code></td>
<td>算术右移（带符号位填充，相当于除以 2 的幂）</td>
</tr>
<tr>
<td><code>xor</code></td>
<td>按位异或</td>
...
<pre><code>    mov     eax, [rsp+0D8h+var_B4]        ; eax = var_B4 (更新后的值)
...
<p>这个时候，就可以试着先把v5（<code>int v5; // [rsp+24h] [rbp-B4h]</code>）的值带进去变换了。</p>
<p>然后就会发现一个问题，右移7位会导致出现 1 / 0 的情况，这显然是会报错的。</p>
<p>这个时候就需要SEH出动了，也就是<code>_except</code>部分</p>
<pre><code>loc_1400011E9:
...
<p>然后我就发现问题了，dword_140005000是会随着v5的更新而更新的。</p>
<p>理解这个之后，解密就好写了。由于XOR的对称性，其实跟我第一轮的密码相比并没有什么太大的区别，只需要加上校验判断以及如果v5右移后的处理（也就是更新dword_140005000）即可。</p>
<p>我的解密脚本</p>
...
<p>也就是说，不要过于依赖F5出来的东西了，去跟踪汇编代码看看哪里隐藏起来了。</p>
]]></content>
    <author>
      <name></name>
    </author>
  ...
  <entry>
    <title>基于BLIP的图像自动描述生成</title>
    <link href="https://dxfaker.top/posts/2661/" rel="alternate" type="text/html"/>
    <id>https://dxfaker.top/posts/2661/</id>
    <published>2026-06-01T00:00:00.000Z</published>
    <updated>2026-06-01T00:00:00.000Z</updated>
    <summary>基于深圳大学人工智能课程项目实现</summary>
    <content type="html"><![CDATA[<h1>前言</h1>
<p><em>C过送过没怂过</em></p>
...
<h1>准备</h1>
<h2>模型</h2>
<p>Salesforce 开源的 <strong>BLIP</strong> 模型，它能根据图像内容自动生成自然语言描述</p>
<h2>环境准备</h2>
<p>双系统+python:WSL2 Ubuntu + Python 3.11</p>
<p>需要安装的库</p>
<pre><code>pip install transformers sentencepiece sacremoses torch torchvision matplotlib
</code></pre>
<ul>
...
<h1>训练脚本</h1>
<p>技术上我们并不需要先写识别一个的以及批量训练的脚本，但是单张可以先看调试效率，以及根据单张出可视化结果，批量脚本专注于文字输出（<code>results.txt</code>），避免为每张图都弹窗或保存图片，节省时间。</p>
<p>且如果要对某张特殊图片调整 <code>max_new_tokens</code>、加入条件提示词（<code>prompt</code>）等，单张脚本改起来更直接，不影响批量处理。</p>
<h2>单张</h2>
<pre><code>from transformers import BlipProcessor, BlipForConditionalGeneration, MarianMTModel, MarianTokenizer
...
<tr>
<td>街景</td>
<td>a busy street with cars and people walking on the sidewalk</td>
<td>一条繁忙的街道，有汽车和行人在人行道上行走</td>
</tr>
<tr>
<td>公园</td>
<td>a park with green trees and a person sitting on a bench</td>
<td>一个有绿树的公园，一个人坐在长椅上</td>
</tr>
<tr>
<td>室内</td>
<td>a living room with a couch and a television on the wall</td>
<td>一个客厅，墙上有沙发和电视</td>
</tr>
<tr>
<td>动物</td>
<td>a dog running on the grass in a garden</td>
<td>一只狗在花园的草地上奔跑</td>
</tr>
<tr>
<td>食物</td>
<td>a plate of food with rice and vegetables on a table</td>
<td>桌上放着一盘有米饭和蔬菜的食物</td>
</tr>
</tbody>
</table>
<p><img src="https://dxfaker.top/images/post/caption_result.jpg" alt="caption_result" /></p>
<p>图片的"[]"是老问题了，后面处理一下。</p>
<p>可以看出，BLIP 对常见场景的描述相当准确，甚至能识别出物体间的空间关系（“沙发和电视在墙上”）。翻译模型整体流畅，偶尔长句语序会有点怪，但作为免费开源的模型已经非常良心了。</p>
<h1>优缺点</h1>
<p>无需训练，支持中英文，能理解复杂场景；缺点则是吃GPU，CPU速度明显比5070慢，倾向于描述主体而失去细节。</p>
<h1>现实应用</h1>
<p>BLIP 的架构（ViT + 语言解码器）是目前主流多模态大模型（如 GPT-4V、LLaVA、Gemini）的基础范式。也可以和yolo结合先识别再描述。</p>
<p>&lt;embed src="/other/image_caption.pdf" width="100%" height="800px" type="application/pdf"&gt;</p>
]]></content>
    <author>
      <name></name>
    </author>
    <category term="实验报告"></category>
  </entry>
  <entry>
    <title>基于 MobileNetV2 的垃圾图像分类</title>
    <link href="https://dxfaker.top/posts/%E5%9F%BA%E4%BA%8E-mobilenetv2-%E7%9A%84%E5%9E%83%E5%9C%BE%E5%9B%BE%E5%83%8F%E5%88%86%E7%B1%BB/" rel="alternate" type="text/html"/>
    <id>https://dxfaker.top/posts/%E5%9F%BA%E4%BA%8E-mobilenetv2-%E7%9A%84%E5%9E%83%E5%9C%BE%E5%9B%BE%E5%83%8F%E5%88%86%E7%B1%BB/</id>
    <published>2026-05-19T00:00:00.000Z</published>
    <updated>2026-05-19T00:00:00.000Z</updated>
    <summary>深圳大学电信学院选修课人工智能实验报告</summary>
    <content type="html"><![CDATA[<h1>基于 MobileNetV2 的垃圾图像分类</h1>
<h2>写在前面</h2>
<p>总算考完转专业考试了，考完也是立马补上了这个实验。</p>
<h2>一、实验目的与要求</h2>
<ul>
...
<hr />
<h2>二、实验方法与步骤</h2>
<h3>1. 激活已有虚拟环境并安装依赖</h3>
<p>直接复用之前实验的 <code>yolo11</code> 虚拟环境，打开 Anaconda Prompt：</p>
<pre><code>conda activate yolo11
pip install torch torchvision matplotlib scikit-learn seaborn
</code></pre>
<h3>2. 准备数据集</h3>
<p>本实验使用已准备好的垃圾分类数据集，包含 10 个类别：
电池（battery）、生物（biological）、纸板（cardboard）、衣物（clothes）、玻璃（glass）、金属（metal）、纸张（paper）、塑料（plastic）、鞋子（shoes）、其他垃圾（trash）。（本次数据集从阿里云下载）</p>
<p>将数据集与脚本放到如下位置:</p>
<pre><code>项目文件夹/
  train.py
  predict.py
...
<h3>3. 编写并运行训练脚本</h3>
<p>新建 <code>train.py</code>，核心内容:</p>
...
<p>然后是预测与验证的事：</p>
<h3>4. 编写并运行预测脚本</h3>
<p>同目录下新建 <code>predict.py</code>：</p>
<pre><code>import torch
import torch.nn as nn
...
<p><img src="https://dxfaker.top/images/post/5.19training_curves.png" alt="5.19training_curves" /></p>
<p><img src="https://dxfaker.top/images/post/5.19confusion_matrix.png" alt="5.19confusion_matrix" /></p>
<h2>四、数据处理与分析</h2>
<h3>1. 各指标含义</h3>
<ul>
...
<h2>五、实验结论</h2>
<p>本实验在包含 10 个类别的垃圾图像数据集上，利用 MobileNetV2 预训练模型进行迁移学习，仅训练 10 个 epoch 即达到 82.1% 的验证准确率,MobileNetV2 参数量少、推理速度快，适合在 CPU 或移动端设备上部署，是实际工程中常用的轻量级分类网络。通过混淆矩阵和分类报告，发现金属、塑料、玻璃三类材质相似的物品容易互相误判，垃圾类别因形态多样也容易出现错误分类。</p>
<h2>六、参考文献</h2>
<ol>
...
<li>Torchvision Models. https://pytorch.org/vision/stable/models.html</li>
</ol>
<h2>七、实验相关词条</h2>
<ol>
...
模型过度学习训练数据中的噪声和特定模式，导致在训练集上表现很好，但在验证集/测试集上表现差。常见于小数据集或模型容量过大时。防止过拟合的方法包括数据增强、正则化、早停等。</li>
    ...
    <category term="report"></category>
  </entry>
  <entry>
    <title>YOLOv11 行人与车辆检测模型训练全记录</title>
    <link href="https://dxfaker.top/posts/yolo11/" rel="alternate" type="text/html"/>
    <id>https://dxfaker.top/posts/yolo11/</id>
    <published>2026-04-20T00:00:00.000Z</published>
    <updated>2026-04-20T00:00:00.000Z</updated>
    <summary>深圳大学电信院的人工智能课程的实验</summary>
    <content type="html"><![CDATA[<p>zhen</p>
<h1>YOLOv11 行人与车辆检测模型训练全记录</h1>
<p><strong>摘要</strong>：目标检测是计算机视觉的核心任务之一，在自动驾驶、智能交通等领域具有重要应用。本文以YOLOv11为基础模型，详细记录了从环境配置、数据集构建、模型训练到视频部署的完整流程。实验结果表明，在515张交通场景图片（含412张训练、103张验证）上训练80轮后，模型整体mAP50达到0.905，其中汽车检测mAP50为0.939，行人检测mAP50为0.871，推理速度达145 FPS。本文重点分析了数据规模对模型性能的决定性作用，并总结了训练过程中遇到的典型问题及解决方案。</p>
<p><strong>关键词</strong>：YOLOv11；目标检测；行人检测；车辆检测；数据扩充；WSL2</p>
<h2>1. 引言</h2>
<p>近年来，基于深度学习的目标检测算法发展迅速，YOLO系列凭借其端到端、实时性高的特点成为工业界和学术界的常用工具。YOLOv11在YOLOv8的基础上引入了C3K2模块、C2PSA注意力机制和SPPF多尺度融合，进一步提升了检测精度与速度。</p>
...
<h2>3. 数据集准备</h2>
<h3>3.1 初始数据集（小规模）</h3>
<p>从RoboFlow下载person-car数据集，共141张图片，包含car和person两个类别。标注格式为YOLO格式（每张图片对应一个.txt文件）。数据集划分如下：</p>
<p>训练集：113张</p>
<p>测试集：28张（未提供独立验证集，临时将测试集用作验证）</p>
<h3>3.2 数据扩充</h3>
<p>初始数据集训练后，行人检测mAP50仅0.330，表明数据量不足。为此，从RoboFlow搜索并下载另一个交通场景数据集，共515张图片，类别同样为car和person。下载后的数据只有train文件夹，需手动划分验证集：</p>
<pre><code>cd /mnt/e/作业提交_深度学习实验/car-person.yolov11
...
<h2>4. 训练</h2>
<p>训练命令</p>
<pre><code>yolo train data=data.yaml model=yolo11n.pt epochs=80 batch=16 imgsz=640 device=0
</code></pre>
<p>结果：mAP50稳步提升.</p>
<p>训练过程中遇到AMP（自动混合精度训练，同时使用FP16和FP32加速并节省显存）检查卡在网络下载，通过手动下载yolo26n.pt或添加amp=False参数解决。</p>
<h2>5. 实验结果</h2>
<h3>5.1 验证集性能</h3>
<p>在103张验证集上的评估结果如表1所示。这里解释几个关键指标：</p>
<ul>
...
<h3>5.2 与初始模型的对比</h3>
<p><strong>表2 数据集规模对性能的影响</strong></p>
<table>
<thead>
<tr>
<th>数据集</th>
...
<h3>5.3 视频检测性能</h3>
<p>使用训练好的模型对一段30秒、1280×720分辨率的路况视频进行检测：</p>
<pre><code>yolo predict model=best.pt source=test.mp4 save=True
</code></pre>
<p>性能数据：</p>
<ul>
...
<h2>7. 结论</h2>
<p>本文完整记录了一次基于YOLOv11的行人与车辆检测模型训练实践。通过对比小数据集与扩充数据集的实验结果，证明了<strong>数据规模对深度学习模型性能具有决定性影响</strong>。最终模型在515张图片上训练80轮后，整体mAP50达到0.905，推理速度145 FPS。本文总结的训练技巧和问题解决方案可为类似项目提供参考。</p>
<p>后面还会对该项目进行进一步修理改进。</p>
<p>详细内容放下文PDF。</p>
<p>&lt;embed src="/other/report.pdf" width="100%" height="800px" type="application/pdf"&gt;</p>
<p><strong>致谢</strong>：感谢深圳大学戴林蕙老师的课程指导，以及RoboFlow平台提供的开源数据集。</p>
  ...
  <entry>
    <title>基于PyRTL的AES-128时序侧信道脆弱性分析</title>
    <link href="https://dxfaker.top/posts/timing-side-channel-vulnerability-analysis-of-aes-128-using-pyrtl/" rel="alternate" type="text/html"/>
    <id>https://dxfaker.top/posts/timing-side-channel-vulnerability-analysis-of-aes-128-using-pyrtl/</id>
    <published>2026-03-14T00:00:00.000Z</published>
    <updated>2026-03-14T00:00:00.000Z</updated>
    <summary>硬件侧信道攻击对加密芯片的安全构成严重威胁。本文提出一种基于PyRTL的预硅验证方法，对AES-128加密电路进行时序分析，量化不同输入汉明权重与关键路径延迟的相关性。实验结果表明，在130nm工艺下，关键路径延迟与输入汉明权重的皮尔逊相关系数达到0.999997，证实了单周期AES实现存在明显的时序泄漏。进一步采用相关性能量分析（CPA）模拟，仅用50条功耗迹线即可成功恢复密钥字节。研究还初步评估了时序掩码防护的有效性。本研究为芯片设计早期的安全评估提供了轻量级、可量化的解决方案，对硬件安全设计与验证具有重要参考价值。</summary>
    <content type="html"><![CDATA[<p>dxfaker</p>
<p>(深圳大学医学部， 广东 深圳)</p>
...
Verification and Post-Silicon Validation[M]. now publishers, 2024.</p>
    ...
    <category term="科研"></category>
  </entry>
  <entry>
    <title>Cryptography入门</title>
    <link href="https://dxfaker.top/posts/%E5%AF%86%E7%A0%81%E5%AD%A6%E9%98%85%E8%AF%BB/" rel="alternate" type="text/html"/>
    <id>https://dxfaker.top/posts/%E5%AF%86%E7%A0%81%E5%AD%A6%E9%98%85%E8%AF%BB/</id>
    <published>2026-03-10T00:00:00.000Z</published>
    <updated>2026-03-10T00:00:00.000Z</updated>
    <summary>自用的神必笔记</summary>
    <content type="html"><![CDATA[<h1>写在前面</h1>
...
<p>具体的过程看原书就是了</p>
    ...
    <category term="导读类"></category>
  </entry>
  <entry>
    <title>处理线性方程组题型</title>
    <link href="https://dxfaker.top/posts/2634/" rel="alternate" type="text/html"/>
    <id>https://dxfaker.top/posts/2634/</id>
    <published>2026-03-05T00:00:00.000Z</published>
    <updated>2026-03-05T00:00:00.000Z</updated>
    <summary>基于WSL的处理办法</summary>
    <content type="html"><![CDATA[<h1>写在前面</h1>
<p>镇楼：届不到的爱恋</p>
...
if s.check() == sat:
  ...
  <entry>
    <title>基于win11的主题优化</title>
    <link href="https://dxfaker.top/posts/%E5%9F%BA%E4%BA%8Ewin11%E7%9A%84%E4%B8%BB%E9%A2%98%E4%BC%98%E5%8C%96/" rel="alternate" type="text/html"/>
    <id>https://dxfaker.top/posts/%E5%9F%BA%E4%BA%8Ewin11%E7%9A%84%E4%B8%BB%E9%A2%98%E4%BC%98%E5%8C%96/</id>
    <published>2026-03-05T00:00:00.000Z</published>
    <updated>2026-03-05T00:00:00.000Z</updated>
    <summary>分享一下</summary>
    <content type="html"><![CDATA[<h1>写在前面</h1>
...
<p>今天莫名其妙压抑了起来，该🛫了</p>
  ...
  <entry>
    <title>今日一题</title>
    <link href="https://dxfaker.top/posts/pywp1/" rel="alternate" type="text/html"/>
    <id>https://dxfaker.top/posts/pywp1/</id>
    <published>2026-03-02T00:00:00.000Z</published>
    <updated>2026-03-02T00:00:00.000Z</updated>
    <summary>解题思路之类的</summary>
    <content type="html"><![CDATA[<h1>写在前面</h1>
<p>镇楼：这样的好兄弟不会再有了</p>
...
<pre><code></code></pre>
  ...
  <entry>
    <title>词条本1</title>
    <link href="https://dxfaker.top/posts/2632/" rel="alternate" type="text/html"/>
    <id>https://dxfaker.top/posts/2632/</id>
    <published>2026-03-02T00:00:00.000Z</published>
    <updated>2026-03-02T00:00:00.000Z</updated>
    <summary>记录自己遇到过的知识，总会有用的</summary>
    <content type="html"><![CDATA[<h1>写在前面</h1>
<p>老婆镇楼</p>
...
int* intPtr = (int*)ptr;       // 需要强制转换后才能使用
  ...
  <entry>
    <title>新开档：逆向</title>
    <link href="https://dxfaker.top/posts/26228/" rel="alternate" type="text/html"/>
    <id>https://dxfaker.top/posts/26228/</id>
    <published>2026-02-28T00:00:00.000Z</published>
    <updated>2026-02-28T00:00:00.000Z</updated>
    <summary>自用笔记</summary>
...
<p>就先这样？</p>
    ...
    <category term="reverse"></category>
  </entry>
  <entry>
    <title>第一篇文章</title>
    <link href="https://dxfaker.top/posts/26224/" rel="alternate" type="text/html"/>
    <id>https://dxfaker.top/posts/26224/</id>
    <published>2026-02-24T00:00:00.000Z</published>
    <updated>2026-02-24T00:00:00.000Z</updated>
    <summary>讲讲开发这个网页的事</summary>
    <content type="html"><![CDATA[<h1>ai指导静态网页开发</h1>
<h2>起因</h2>
<p>第一篇就拿很熟悉的一张当封面吧
