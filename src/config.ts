...
export const siteConfig: SiteConfig = {
	...
	banner: {
		...
		src: {
			desktop: [
				"/assets/desktop-banner/aaa.webp",
				"/assets/desktop-banner/bg2.jpg",
				"/assets/desktop-banner/a3.webp",
				"/assets/desktop-banner/a4.webp",
				"/assets/desktop-banner/a5.jpg",
				"/assets/desktop-banner/a6.JPG",
				"/assets/desktop-banner/a7.avif",
				"/assets/desktop-banner/a8.avif",
				"/assets/desktop-banner/a9.avif",
				"/assets/desktop-banner/a10.webp",
				"/assets/desktop-banner/a11.avif",
				"/assets/desktop-banner/a12.png",
			], // 桌面横幅图片
			mobile: [
				"/assets/mobile-banner/z1.avif",
				"/assets/mobile-banner/z2.avif",
				"/assets/mobile-banner/a3.png",
				"/assets/mobile-banner/z4.webp",
				"/assets/mobile-banner/m5.webp",
				"/assets/mobile-banner/m6.webp",
				"/assets/mobile-banner/m7.avif",
			], // 移动横幅图片
		}, // 使用本地横幅图片
		...
		homeText: {
			...
			title: "dxfaker's site", // 主页横幅主标题

			subtitle: [
				"A Little Site at My Own Whim",
				"Updates by fate, occasional resurrections.",
				"A corner for ideas.",
	...
	links: [
		...
		// 支持自定义导航栏链接,并且支持多级菜单,3.1版本新加
		{
			...
			children: [
				{
					name: "GitHub",
					url: "https://github.com/dxfaker",
					external: true,
					icon: "fa6-brands:github",
				},
				{
					name: "Bilibili",
					url: "https://space.bilibili.com/479112329",
					external: true,
					icon: "fa6-brands:bilibili",
				},
				{
					name: "X",
					url: "https://x.com/B0699914076454",
					external: true,
					icon: "fa6-brands:x-twitter",
				},
				{
					name: "贴吧",
					url: "https://tieba.baidu.com/home/main?id=tb.1.ed372b7b.6us6IlRvKC4N61tXujNKEQ",
					external: true,
		...
		},
		{
			...
			children: [
				...
				{
					name: "追番（先这样，后面改）",
					url: "https://space.bilibili.com/479112329/bangumi",
					external: true,
					icon: "fa6-brands:bilibili",
				},
				// 以后想恢复日记或相册，再取消注释或添加
...
export const pioConfig: import("./types/config").PioConfig = {
	...
	dialog: {
		...
		link: "https://github.com/dxfaker/dxfaker.github.io", // 关于链接
	},
};
